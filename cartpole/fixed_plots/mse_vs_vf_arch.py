...
def main():
    ...
    x_labels = ['0-0','1-128', '1-256', '1-512']
    length = len(data)
    ...
    '''
    ax.bar(x[0] + (0 * width), data[0,0], width, yerr=data_std[0,0], color = 'tab:red', edgecolor = 'None')
    ...
    ax.bar(x[0] + (1 * width), data[0,1], width, yerr=data_std[0,1], color = 'tab:blue', edgecolor = 'None')
