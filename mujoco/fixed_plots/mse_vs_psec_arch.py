...
def main():
    ...
    ax.bar(x[0] + (0 * width), data[0,0], width,yerr=data_std[0,0], color = 'tab:blue', edgecolor = 'None')
    ax.bar(x[1] + (0 * width), data[1,0], width,yerr=data_std[1,0], color = 'tab:blue', edgecolor = 'None', alpha = 0.5)
    ax.bar(x[2:3] + (0 * width), data[2:3,0], width,yerr=data_std[2:3,0], color = 'tab:blue', edgecolor = 'None')
    ax.bar(x[3:] + (0 * width), data[3:,0], width,yerr=data_std[3:,0], color = 'tab:red', edgecolor = 'None')
