...
def main():
    ...
    '''
    ax.bar(x[0] + (0 * width), data[0,0], width, yerr=data_std[0,0], color = 'tab:red', edgecolor = 'None', alpha = 0.5)
    ax.bar(x[1] + (0 * width), data[1,0], width, yerr=data_std[1,0], color = 'tab:red', edgecolor = 'None', alpha = 0.5)
    ax.bar(x[2:] + (0 * width), data[2:,0], width, label='TD(0)', yerr=data_std[2:,0], color = 'tab:red', edgecolor = 'None')   
    ax.bar(x[0] + (1 * width), data[0,1], width, yerr=data_std[0,1], color = 'tab:blue', edgecolor = 'None', alpha = 0.5)
    ax.bar(x[1] + (1 * width), data[1,1], width, yerr=data_std[1,1], color = 'tab:blue', edgecolor = 'None', alpha = 0.5)
    ax.bar(x[2:] + (1 * width), data[2:,1], width, label = 'PSEC-TD(0)', yerr=data_std[2:,1], color = 'tab:blue', edgecolor = 'None')     
    ...
    ax.set_xlabel('VF Model Architecture')
