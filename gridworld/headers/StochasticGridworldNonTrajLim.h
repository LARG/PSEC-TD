#ifndef _STOCHASTICGRIDWORLDNONTRAJLIM_H_
#define _STOCHASTICGRIDWORLDNONTRAJLIM_H_
...
class StochasticGridworldNonTrajLim : public Environment {
public:
	StochasticGridworldNonTrajLim(bool trueHorizon, float deterministic_prob);
	...
	int getNextState(int state, int action, mt19937_64 & generator);
